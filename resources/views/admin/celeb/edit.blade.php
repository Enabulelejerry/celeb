    ...
    <div class="container-full">
      ...
      <section class="content">
          <div class="row">
            <div class="box p-15">
				{{-- {{ route('store.post') }}		 --}}
                <form action="{{ route('update.celeb',$celeb->id) }}" method="post" enctype="multipart/form-data"  class="form-horizontal form-element col-12">
                @csrf
					...
					<div class="col-sm-6">
                        <div class="mb-4">
							<textarea id="editor1" name="description" class="@error('description')  is-invalid  @enderror"  rows="10" cols="80">
								{{  html_entity_decode($celeb->description) }}
							</textarea>
						  </div>
						  @error('description')
						<div class="text-danger">{{ $message }}</div>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="col-sm-4">
                    <div class="controls">
                        <img id="showImage" src="{{  url($celeb->image) }}" alt="" style="width:100px; height:100px; border:1px solid #000">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <div class="ml-auto col-sm-10">
                      <button type="submit" class="btn btn-rounded btn-success">update celeb</button>
                    </div>
                  </div>
                </form>
            </div>
